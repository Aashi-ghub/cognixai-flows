...
const services = [
  {
    ...
    description: "Connect disparate systems and processes into unified, intelligent workflows."
  },
  {
    icon: Headphones,
    title: "Customer Service Agent Deployment",
    description: "Deploy AI-powered agents that handle customer inquiries with human-like understanding."
  },
  {
    icon: AlertTriangle,
    title: "Supply Chain Anomaly Detection",
    description: "Identify and respond to supply chain disruptions before they impact operations."
  }
];

const ProcessOrchestration = () => {
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Siloed automation creates technical debt. We focus on "Orchestration"—connecting human workers, 
              legacy systems, and AI agents into a seamless, resilient workflow.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Let's discuss how intelligent orchestration can unify your operations.
            </p>
            <button
              onClick={openPopup}
