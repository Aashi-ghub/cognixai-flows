...
const services = [
  ...
  {
    icon: Users,
    title: "Workforce Reskilling & Adoption Programs",
    description: "Training programs that prepare your team to work alongside AI agents effectively."
  },
  {
    icon: Building2,
    title: "Center of Excellence (CoE) Design",
    description: "Establish an internal hub for AI best practices, standards, and continuous improvement."
  }
];
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Technology succeeds; people fail. This cluster ensures your workforce is prepared to work 
              alongside AI agents, shifting the culture from fear of replacement to augmentation.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 
              ...
              style={{ fontFamily: "'Instrument Serif', Georgia, serif" }}
            >
              Ready to enable your workforce for AI?
            </h2>
            <p className="text-lg text-muted-foreground mb-8">
              Let's discuss how to prepare your organization for the AI-augmented future.
            </p>
            <button
              onClick={openPopup}
